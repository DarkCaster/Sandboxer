...
ln -rs "$target/bin/sandboxer.sh" "$bin_dir/sandboxer"
rm -f "$bin_dir/sandboxer-kill"
ln -rs "$target/bin/sandboxer-kill.sh" "$bin_dir/sandboxer-kill"
rm -f "$bin_dir/sandboxer-term"
ln -rs "$target/bin/sandboxer-term.sh" "$bin_dir/sandboxer-term"
...
ln -rs "$target/bin/sandboxer-desktop-file-creator" "$bin_dir/sandboxer-desktop-file-creator"
